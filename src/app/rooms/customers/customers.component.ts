...
import { CustomersFormDialogComponent } from './dialogs/customers-form-dialog/customers-form-dialog.component';
import { CustomersDeleteComponent } from './dialogs/customers-delete/customers-delete.component';
...
export class CustomersComponent implements OnInit {
  ...
  addNew() {
    const dialogRef = this.dialog.open(CustomersFormDialogComponent, {
      data: {
  ...
  deleteItem(row) {
    this.id = row.id;
    const dialogRef = this.dialog.open(CustomersDeleteComponent, {
      data: row,
    });
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: Customers) {
...
export class ExampleDataSource extends DataSource<Customers> {
  ...
  constructor(
    public _exampleDatabase: CustomersService,
